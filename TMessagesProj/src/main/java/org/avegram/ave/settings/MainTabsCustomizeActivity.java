...
public class MainTabsCustomizeActivity extends BaseAveSettingsActivity {
        ...
        private void rebuildTabs(Context context) {
            ...
            for (int i = 0; i < tabs.size(); i++) {
                ...
                tabView.setOnLongClickListener(v -> {
                    MainTabsConfigManager.TabState clicked = tabs.get(index);
                    if (AveConfig.navigationDrawerEnabled.Bool() && clicked.type == MainTabsConfigManager.TabType.CHATS) {
                        return false;
                    }
