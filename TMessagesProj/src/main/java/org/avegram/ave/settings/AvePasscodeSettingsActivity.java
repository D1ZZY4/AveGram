...
import org.avegram.ave.ui.cells.AccountCell;
import org.avegram.ave.ui.cells.HeaderCell;
import org.avegram.NaConfig;

public class AvePasscodeSettingsActivity extends BaseAveSettingsActivity {
    ...
    protected String getActionBarTitle() {
        return getString(R.string.PasscodeAve);
    }
                    ...
                    if (position == accountsEndRow) {
                        ...
                        stringBuilder.setSpan(new URLSpanNoUnderline(null) {
                            ...
                            public void onClick(@NonNull View view) {
                                ...
                                BulletinFactory.of(AvePasscodeSettingsActivity.this).createCopyLinkBulletin().show();
                            }
