...
import org.avegram.ave.ui.cells.AvatarCornersPreviewCell;
import org.avegram.NaConfig;

@SuppressLint("RtlHardcoded")
@SuppressWarnings({"unused", "FieldCanBeLocal"})
public class AveAppearanceSettingsActivity extends BaseAveXSettingsActivity {
    ...
    private final AbstractConfigCell typefaceRow = cellGroup.appendCell(new ConfigCellTextCheck(AveConfig.typeface));
    ...
    private final AbstractConfigCell actionBarDecorationRow = cellGroup.appendCell(new ConfigCellSelectBox(null, AveConfig.actionBarDecoration, new String[]{
    ...
    private final AbstractConfigCell notificationIconRow = cellGroup.appendCell(new ConfigCellSelectBox(null, NaConfig.INSTANCE.getNotificationIcon(), new String[]{
            ...
            getString(R.string.AveGram),
            getString(R.string.AveX)
    }, null));
    private final AbstractConfigCell tabletModeRow = cellGroup.appendCell(new ConfigCellSelectBox(null, AveConfig.tabletMode, new String[]{
    ...
    private final AbstractConfigCell mediaPreviewRow = cellGroup.appendCell(new ConfigCellTextCheck(AveConfig.mediaPreview));
    ...
    private final AbstractConfigCell hideAllTabRow = cellGroup.appendCell(new ConfigCellTextCheck(AveConfig.hideAllTab, getString(R.string.HideAllTabAbout)));
    ...
    private final AbstractConfigCell openArchiveOnPullRow = cellGroup.appendCell(new ConfigCellTextCheck(AveConfig.openArchiveOnPull));
    ...
    private final AbstractConfigCell tabsTitleTypeRow = cellGroup.appendCell(new ConfigCellSelectBox(null, AveConfig.tabsTitleType, new String[]{
    ...
    private final AbstractConfigCell navigationDrawerRow = cellGroup.appendCell(
            new ConfigCellTextCheck(AveConfig.navigationDrawerEnabled, null, getString(R.string.HomeDrawer))
    );
    private final AbstractConfigCell drawerElementsRow = cellGroup.appendCell(new ConfigCellTextCheckIcon(null, "DrawerElements", getString(R.string.DrawerElements), R.drawable.menu_newfilter, false, () ->
            showDialog(showConfigMenuWithIconAlert(this, R.string.DrawerElements, new java.util.ArrayList<>() {{
                ...
                add(new ConfigCellTextCheckIcon(NaConfig.INSTANCE.getDrawerItemNSettings(), getString(R.string.AveSettings), R.drawable.avegram_drawer_outline));
    ...
    private final AbstractConfigCell forceBlurInChatRow = cellGroup.appendCell(new ConfigCellTextCheck(AveConfig.forceBlurInChat));
    ...
    private final AbstractConfigCell chatBlurAlphaValueRow = cellGroup.appendCell(new ConfigCellCustom("ChatBlurAlphaValue", ConfigCellCustom.CUSTOM_ITEM_CharBlurAlpha, AveConfig.forceBlurInChat.Bool()));
    ...
    public AveAppearanceSettingsActivity() {
    ...
    public View createView(Context context) {
        ...
        cellGroup.callBackSettingsChanged = (key, newValue) -> {
            if (key.equals(AveConfig.actionBarDecoration.getKey())
                    ...
                    || key.equals(AveConfig.hideAllTab.getKey())
                    ...
                    || key.equals(AveConfig.navigationDrawerEnabled.getKey())) {
                tooltip.showWithAction(0, UndoView.ACTION_NEED_RESTART, null, null);
            } else if (key.equals(AveConfig.forceBlurInChat.getKey())) {
    ...
    private void animateActionBarUpdate(BaseAveXSettingsActivity fragment) {
        ...
        protected View onCreateCustomViewHolder(@NonNull ViewGroup parent, int viewType) {
            return switch (viewType) {
                case ConfigCellCustom.CUSTOM_ITEM_AvatarCorners -> avatarCornersPreviewCell = new AvatarCornersPreviewCell(
                        mContext,
                        AveAppearanceSettingsActivity.this::reloadAvatarCorners
                );
                case ConfigCellCustom.CUSTOM_ITEM_CharBlurAlpha -> {
                    chatBlurAlphaSeekbar = new ChatBlurAlphaSeekBar(mContext);
                    chatBlurAlphaSeekbar.setEnabled(AveConfig.forceBlurInChat.Bool());
    ...
    private static class ChatBlurAlphaSeekBar extends FrameLayout {
        ...
        public ChatBlurAlphaSeekBar(Context context) {
            ...
            sizeBar.setDelegate((stop, progress) -> {
                AveConfig.chatBlueAlphaValue.setConfigInt(Math.min(255, (int) (255 * progress)));
                invalidate();
            });
            sizeBar.setOnTouchListener((v, event) -> !enabled);
            sizeBar.setProgress(AveConfig.chatBlueAlphaValue.Int());
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.drawText(String.valueOf(AveConfig.chatBlueAlphaValue.Int()), getMeasuredWidth() - dp(39), dp(28), textPaint);
        }

        @Override
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            super.onMeasure(widthMeasureSpec, heightMeasureSpec);
            sizeBar.setProgress((AveConfig.chatBlueAlphaValue.Int() / 255.0f));
        }
