...
import org.avegram.ave.helpers.TimeStringHelper;
import org.avegram.ave.ui.cells.DeletedMessagesColorPickerCell;
import org.avegram.ave.ui.cells.DeletedMessagesPreviewCell;
import org.avegram.ave.ui.cells.HeaderCell;
import org.avegram.NaConfig;

@SuppressLint("RtlHardcoded")
@SuppressWarnings("unused")
public class AveAyuMomentsSettingsActivity extends BaseAveXSettingsActivity {
    ...
    public AveAyuMomentsSettingsActivity() {
        ...
        protected View onCreateCustomViewHolder(@NonNull ViewGroup parent, int viewType) {
            if (viewType == CellGroup.ITEM_TYPE_TEXT_CHECK) {
                ...
                slideChooseView.setCallback(index -> {
                    ...
                    AyuData.loadSizes(AveAyuMomentsSettingsActivity.this::refreshAyuDataSize);
                });
