...
public class AveExperimentalSettingsActivity extends BaseAveXSettingsActivity {
    ...
    private final AbstractConfigCell localPremiumRow = cellGroup.appendCell(new ConfigCellTextCheck(AveConfig.localPremium));
    ...
    private final AbstractConfigCell unlimitedPinnedDialogsRow = cellGroup.appendCell(new ConfigCellTextCheck(AveConfig.unlimitedPinnedDialogs, getString(R.string.UnlimitedPinnedDialogsAbout)));
    private final AbstractConfigCell unlimitedFavedStickersRow = cellGroup.appendCell(new ConfigCellTextCheck(AveConfig.unlimitedFavedStickers, getString(R.string.UnlimitedFavoredStickersAbout)));
    ...
    private final AbstractConfigCell boostUploadRow = cellGroup.appendCell(new ConfigCellTextCheck(AveConfig.uploadBoost));
    private final AbstractConfigCell enhancedFileLoaderRow = cellGroup.appendCell(new ConfigCellTextCheck(AveConfig.enhancedFileLoader));
    ...
    private final AbstractConfigCell hideProxySponsorChannelRow = cellGroup.appendCell(new ConfigCellTextCheck(AveConfig.hideProxySponsorChannel));
    private final AbstractConfigCell hideSponsoredMessageRow = cellGroup.appendCell(new ConfigCellTextCheck(AveConfig.hideSponsoredMessage));
    private final AbstractConfigCell disableChoosingStickerRow = cellGroup.appendCell(new ConfigCellTextCheck(AveConfig.disableChoosingSticker));
    ...
    public AveExperimentalSettingsActivity() {
    ...
    public View createView(Context context) {
        ...
        cellGroup.callBackSettingsChanged = (key, newValue) -> {
            if (key.equals(NaConfig.INSTANCE.getDisableStories().getKey())) {
            ...
            } else if (key.equals(AveConfig.localPremium.getKey())) {
                ...
                tooltip.showWithAction(0, UndoView.ACTION_NEED_RESTART, null, null);
            } else if (key.equals(AveConfig.hideSponsoredMessage.getKey())) {
                tooltip.showWithAction(0, UndoView.ACTION_NEED_RESTART, null, null);
            } else if (key.equals(AveConfig.hideProxySponsorChannel.getKey())) {
    ...
    protected void onCustomCellClick(View view, int position, float x, float y) {
        if (position == cellGroup.rows.indexOf(disableFilteringRow)) {
            ...
            builder.setItems(new String[]{
                ...
                switch (i) {
                    case 0:
                        AveConfig.customAudioBitrate.setConfigInt(32);
                        break;
                    case 1:
                        AveConfig.customAudioBitrate.setConfigInt(64);
                        break;
                    case 2:
                        AveConfig.customAudioBitrate.setConfigInt(128);
                        break;
                    case 3:
                        AveConfig.customAudioBitrate.setConfigInt(192);
                        break;
                    case 4:
                        AveConfig.customAudioBitrate.setConfigInt(256);
                        break;
                    case 5:
                        AveConfig.customAudioBitrate.setConfigInt(320);
                        break;
                }
        ...
        protected void onBindCustomViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
            if (holder.itemView instanceof TextCheckCell textCheckCell) {
                ...
                if (position == cellGroup.rows.indexOf(customAudioBitrateRow)) {
                    String value = AveConfig.customAudioBitrate.Int() + "kbps";
                    if (AveConfig.customAudioBitrate.Int() == 32)
