...
import org.avegram.ave.translate.code2Locale
import org.avegram.ave.translate.locale2code
...
fun ChatActivity.translateMessages(
    targetLocale: Locale = AveConfig.translateToLang.String().code2Locale,
    provider: Int = 0,
