...
import org.avegram.ave.translate.source.fallback.GoogleTranslatorAve
import org.avegram.ave.utils.HttpClient
...
object GoogleTranslator : Translator {
    ...
    override suspend fun doTranslate(
        ...
        val translated = try {
            ...
            try {
                FileLog.e("Cloud Translation API request failed, trying to use Avegram's translation API...", e)
                GoogleTranslatorAve.translate(textToTranslate, from, to)
            } catch (e: Exception) {
