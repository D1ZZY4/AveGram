package org.avegram.ave.ui;

import static org.telegram.messenger.LocaleController.getString;
import static org.avegram.ave.parts.MessageTransKt.TRANSLATION_SEPARATOR;
...
public abstract class AveDelegateFragment extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, AveMessageCell.AveMessageCellDelegate {
    ...
    protected class ScrimFrameLayout extends SizeNotifierFrameLayout {
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            AveDelegateFragment.this.drawScrimOverlay(this, canvas);
        }
    }
    ...
    protected void toggleOrTranslate(@NonNull ChatMessageCell messageCell, @NonNull MessageObject messageObject, Locale targetLocale) {
        ...
        if (targetLocale == null) {
            String lang = AveConfig.translateToLang.String();
