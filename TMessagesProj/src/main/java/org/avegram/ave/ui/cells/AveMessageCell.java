package org.avegram.ave.ui.cells;
...
public class AveMessageCell extends ChatMessageCell {
    ...
    @Nullable
    private AveMessageCellDelegate ayuDelegate;

    public AveMessageCell(Context context, int currentAccount) {
        ...
        setDelegate(new ChatMessageCell.ChatMessageCellDelegate() {
            ...
            public void didPressUrl(ChatMessageCell cell, CharacterStyle urlSpan, boolean longPress) {
                if (longPress) {
                    ...
                    if (longPressRunnable != null) {
                        AveMessageCell.this.removeCallbacks(longPressRunnable);
                    }
                    ...
                    Optional.ofNullable(ayuDelegate).ifPresent(AveMessageCellDelegate::onTextCopied);
                    return;
                }
                try {
            ...
            public void forceUpdate(ChatMessageCell cell, boolean anchorScroll) {
                ...
                if (msg != null) {
                    ...
                    AveMessageCell.this.setMessageObject(msg, null, AveMessageCell.this.pinnedBottom, AveMessageCell.this.pinnedTop, AveMessageCell.this.firstInChat);
                    msg.forceUpdate = false;
                }
                AveMessageCell.this.requestLayout();
                AveMessageCell.this.invalidate();
                ViewParent p = AveMessageCell.this.getParent();
    ...
    public void setAyuDelegate(@Nullable AveMessageCellDelegate ayuDelegate) {
    ...
    public interface AveMessageCellDelegate {
        void onTextCopied();
