package org.avegram.ave.folder;
...
public class FolderIconHelper {
    ...
    public static int getPadding() {
        if (AveConfig.tabsTitleType.Int() == AveXConfig.TITLE_TYPE_MIX) {
            return dp(3);
        }
        return 0;
    }
    ...
    public static float getTabInternalPadding() {
        ...
        if (AveConfig.tabsTitleType.Int() != AveXConfig.TITLE_TYPE_ICON) {
            return padding;
        }
        return padding/2;
    }
    ...
    public static int getTotalIconWidth() {
        int result = 0;
        if (AveConfig.tabsTitleType.Int() != AveXConfig.TITLE_TYPE_TEXT) {
