...
import static org.avegram.ave.config.ConfigItem.configTypeBool;
import static org.avegram.ave.config.ConfigItem.configTypeFloat;
import static org.avegram.ave.config.ConfigItem.configTypeInt;
import static org.avegram.ave.config.ConfigItem.configTypeLong;
import static org.avegram.ave.config.ConfigItem.configTypeMapIntInt;
import static org.avegram.ave.config.ConfigItem.configTypeSetInt;
import static org.avegram.ave.config.ConfigItem.configTypeString;
...
public class AveConfig {
    ...
    public static final int MARKDOWN_PARSER_AVE = 1;
    ...
    public static ConfigItem customSavePath = addConfig("customSavePath", configTypeString, "AveGram");
    ...
    public static ConfigItem tabsTitleType = addConfig("TabTitleType", configTypeInt, AveXConfig.TITLE_TYPE_TEXT);
