...
public class BlockingUpdateView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public BlockingUpdateView(final Context context) {
        ...
        imageView.setImageResource(R.mipmap.ic_launcher_avegram);
        ...
        titleTextView.setText(LocaleController.getString(R.string.UpdateTelegram).replace("Telegram", LocaleController.getString(R.string.AveGram)));
