...
import org.avegram.ave.shamsicalendar.PersianDate;
...
public class LocaleController {
        ...
        if (formatterDay == null) {
            synchronized (this) {
                if (formatterDay == null) {
                    ...
                    formatterDay = createFormatter(lang.toLowerCase().equals("ar") || lang.toLowerCase().equals("ko") ? locale : Locale.US, (is24HourFormat ? getStringInternal("formatterDay24H", R.string.formatterDay24H) : getStringInternal("formatterDay12H", R.string.formatterDay12H)).replace(":mm", AveConfig.showSeconds.Bool() ? ":mm:ss" : ":mm"), (is24HourFormat ? "HH:mm" : "h:mm a").replace(":mm", AveConfig.showSeconds.Bool() ? ":mm:ss" : ":mm"));
                }
            }
        }
        return formatterDay;
        ...
        if (formatterConstDay == null) {
            synchronized (this) {
                if (formatterConstDay == null) {
                    ...
                    lang = lang.toLowerCase();
                    formatterConstDay = createFormatter(lang.toLowerCase().equals("ar") || lang.toLowerCase().equals("ko") ? locale : Locale.US, (is24HourFormat ? "HH:mm" : "h:mm a").replace(":mm", AveConfig.showSeconds.Bool() ? ":mm:ss" : ":mm"), (is24HourFormat ? "HH:mm" : "h:mm a").replace(":mm", AveConfig.showSeconds.Bool() ? ":mm:ss" : ":mm"));
                }
            }
        }
    ...
    public static boolean usePersianCalendar = AveConfig.usePersianCalendar.Bool();
    ...
    public static String formatShortNumber(int number, int[] rounded) {
        if (AveConfig.disableNumberRounding.Bool()) {
            if (rounded != null) {
                rounded[0] = number;
            }
