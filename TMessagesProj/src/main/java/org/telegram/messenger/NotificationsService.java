...
public class NotificationsService extends Service {
    ...
    public void onCreate() {
        ...
        if (NaConfig.INSTANCE.getPushServiceTypeInAppDialog().Bool()) {
            ...
            NotificationChannel channel = new NotificationChannel(CHANNEL_ID, LocaleController.getString(R.string.AveGramPushService), NotificationManager.IMPORTANCE_DEFAULT);
...
//                    .setContentIntent(explainPendingIntent)
                    .setShowWhen(false)
                    .setOngoing(true)
                    .setSmallIcon(R.drawable.ave_notification)
                    .setContentText(LocaleController.getString(R.string.AveGramPushService))
                    .build();
            try {
